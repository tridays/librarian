...
public class LoanController extends BaseController {
    ...
    public Object cancelLend(@PathVariable Long lendId) {
        loanService.cancelLending(getAccount(), lendId);
    ...
    public Object renewLend(@PathVariable Long lendId) {
        return renderForEntity(loanService.renewLending(getAccount(), lendId));
    }
    ...
    public Object cancelReservation(@PathVariable Long loanId) {
        loanService.cancelReservation(getAccount(), loanId);
        return renderForAction(true);
    }
