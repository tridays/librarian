...
public class AdminLoanController extends BaseController {
    ...
    @PostMapping("lends/{loanId}/accept")
    public Object acceptLending(@PathVariable Long loanId) {
        loanService.acceptLending(loanId);
    ...
    @PostMapping("lends/{loanId}/reject")
    public Object rejectLending(@PathVariable Long loanId) {
        loanService.rejectLending(loanId);
        return renderForAction(true);
    }
    ...
    @PostMapping("lends/{loanId}/confirmReturned")
    public Object confirmReturned(@PathVariable Long loanId) {
        loanService.confirmReturned(loanId);
        return renderForAction(true);
    }
    ...
    @PostMapping("lends/{loanId}/confirmDisabled")
    public Object confirmDisabled(@PathVariable Long loanId) {
        loanService.confirmDisabled(loanId);
        return renderForAction(true);
    }
