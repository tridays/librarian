...
public final class MurmurHash3 {
    ...
    public static void x64_128(byte[] key, int offset, int len, int seed, LongPair out) {
    ...
    public static long x64_64(byte[] bytes, int offset, int len, int seed) {
        LongPair pair = new LongPair();
        x64_128(bytes, offset, len, seed, pair);
        return pair.h1;
    }

    public static long x64_64(byte[] bytes, int seed) {
        return x64_64(bytes, 0, bytes.length, seed);
    }

    public static long x64_64(String data, int seed) {
        return x64_64(data.getBytes(utf8), seed);
    }

    public static long x64_64(String data, int offset, int len, int seed) {
        return x64_64(data.substring(offset, offset + len), seed);
    }

    public static long x64_64(String data) {
        return x64_64(data, seed);
    }
